"""
Django settings for landBorderP project.
...
SECRET_KEY = 'django-insecure-$+coc(j10aonuux$q$ou%&bvrz=@2ba9u(sh5rf&f8cwxm&kud'
...
JAZZMIN_SETTINGS = {
     "site_title": "LAND-BORDER",
     "site_header": "Land-Border",
    #  "site_logo": "/images/logo/logo-4.png",
     "copyright": "copyright @landBorder 2023",
...
WSGI_APPLICATION = 'landBorderP.wsgi.application'
